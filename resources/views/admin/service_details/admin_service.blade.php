                    ...
                    <div class="card-header">
                        ...
                        @endif
                            ...
                            <div class="form-group">
                                ...
                                <textarea name="description" id="description" class="form-control" rows="2" required>{{ isset($aisItem) ? $aisItem->description : '' }}</textarea>
                            </div>
